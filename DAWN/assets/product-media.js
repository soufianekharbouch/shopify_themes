  ...
  customElements.define("media-gallery", class MediaGallery extends HTMLElement {
    ...
    initSlider() {
      ...
      loadAssets(["swiper.css", "swiper.js"]).then(() => {
        ...
        if (this.enableVariantGroupImages) configNav = Object.assign({
          loop: false
        }, configNav);
        ...
        let config = Object.assign({}, getProductSliderConfig(this.layout), {
          initialSlide,
          autoHeight: true,
          navigation: {
            nextEl,
        ...
        if (this.enableVariantGroupImages) config = Object.assign({
          loop: false
        }, config);
